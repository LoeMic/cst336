...
$(document).ready(function()
{
    ...
    $("form").submit(function(event) {
        ...
        // need to reset the score or it keeps adding for re-submits
        score = 0;
        ...
        $("#question3-feedback").append("The answer is <strong>1977</strong>");
        ...
        $("#question4-feedback").append("The answer is <strong>Orange</strong>");

        //Displays quiz score
        $("#score").html(score);
        $("#awaiting").html("<img src='img/loading.gif' alt='submitting data' />");
